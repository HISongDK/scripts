...
;(function () {
    ...
    function createLoading() {
        ...
        loading.className =
            'zoomin-loading css-1dbjc4n r-17bb2tj r-1muvv40 r-127358a r-1ldzwu0'
        loading.innerHTML = svgLoading
        loading.querySelectorAll('circle').forEach((circle) => {
            circle.style.stroke = getColor()
        })
    ...
    function sensitiveContent() {
        document
            .querySelectorAll('.r-42olwf.r-1vsu8ta:not(.zoomin-view)')
            .forEach((view) => {
